...
Il peut être utile d'installer DBeaver ou pgAdmin pour faciliter la gestion des bases footnote:[Installation de DBeaver via Snap sous Manjaro : [https://snapcraft.io/docs/installing-snap-on-manjaro-linux]. Une fois Snap installé et configuré, on peut executer la commande 
[source, bash]
----
